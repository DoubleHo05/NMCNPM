        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          ...
          {isManager && (
            <>
              ...
              <SidebarItem to="/admin/users" icon={Shield} label="Quản lý Users (Redux)" />
              <SidebarItem to="/admin/rules" icon={Cog} label="Cấu hình Quy định" />
            </>
          )}
          ...
          <SidebarItem to="/warehouse/import" icon={FilePlus} label="Nhập kho" />
          <SidebarItem to="/warehouse/list" icon={Wallet} label="Danh sách kho" />
        </nav>
